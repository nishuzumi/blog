---
title: zk-SNARKs 在 Solidity 中的使用
---
...
![运行成功](/2023-08-31-18-10-30.png)

import { BaseLink } from "components/base_link";

项目的基础文件都放在: <BaseLink href="sources/zk">Github 仓库</BaseLink>[]()中，欢迎 Star。
