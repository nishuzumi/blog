...
在这篇文章中，我们的目标是从实用的角度对 zk-SNARKs 进行概述。我们将把实际的数学问题视为一个黑箱，并试图围绕我们如何使用它们来发展一些直觉。我们还将展示一项关于[
在以太坊中集成 zk-SNARKs 的最近工作的简单应用 ](https://blog.ethereum.org/2017/01/19/update-integrating-zcash-ethereum/)。
